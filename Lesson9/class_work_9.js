...
for (const simpson of simpsons) {
    ...
    divElement.append(nameDiv,  surnameDiv, ageDiv, infoDiv, imgDiv);
...
for (const item of coursesArray) {
    ...
    let modulsUl = document.createElement('ul');

    for (const modul of item.modules) {
        let li = document.createElement("li");
        li.innerText = modul;
        modulsUl.appendChild(li)
    }

    mainDiv.appendChild(modulsUl);
    dataDiv.append(monthDiv, hourDiv);
    document.body.append(titleDiv, dataDiv, mainDiv);
}