...
for (let user of usersList) {
    ...
    geoDiv.innerText = "Location :"
    let latDiv = document.createElement("div");
    latDiv.innerText = user.address.geo.lat;

    let lngDiv = document.createElement("div");
    lngDiv.innerText = user.address.geo.lng;

    geoDiv.append(latDiv, lngDiv);
    addressDiv.append(streetDiv, suiteDiv, cityDiv, zipcodeDiv, geoDiv);

    let phoneDiv = document.createElement("div");
    phoneDiv.innerText = `Number phone  -${user.phone}`;


    let websiceDiv = document.createElement("div");
    websiceDiv.innerText = `Website  - ${user.website}`;

    let companyDiv = document.createElement("div");
    let nameCompanyDiv = document.createElement("div");
    nameCompanyDiv.innerText = `Company name - ${user.company.name}`;

    let catchPhraseDiv = document.createElement("div");
    catchPhraseDiv.innerText = `Company phrase - ${user.company.catchPhrase}`;

    let bsDiv = document.createElement("div");
    bsDiv.innerText = `Bs - ${user.company.bs}`;

    let mainDiv = document.createElement("div");
    mainDiv.classList.add("box")
    mainDiv.append(divId, nameDiv, usernameDiv, emailDiv, addressDiv, phoneDiv, websiceDiv, companyDiv);

    companyDiv.append(nameCompanyDiv, catchPhraseDiv, bsDiv);
